...
function showDogs(dogssArray) {
    ...
    dogssArray.forEach(dogObj => {
        const dogHeader = createDogsTable(dogObj);
        dogsTable.appendChild(dogHeader);
    });
}

function createDogsTable(dogsObj) {
    dogHeader = document.createElement("tr"),
